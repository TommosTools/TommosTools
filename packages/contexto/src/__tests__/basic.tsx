...
test("useContexts", () =>
{
	...
	expect(screen.getByTestId("use-contexts-array-0"))
		.toHaveTextContent("default value1,default value2,default value1");
...
test("initialValue", () =>
{
	...
	const ShowIfContextEquals = ({ value, children }: { value: string, children: ReactElement }) =>
	{
