		...
		const ProvidersWithClickToSetProviderValue = () =>
			{
				...
				return (<>
					<div data-testid="ClickTarget" onClick={ () => setValue("updated value") }>click</div>
		...
		const OuterComponent = () =>
			{
				...
				return (<>
					<div data-testid="ClickTargetProp1" onClick={ () => setValue("prop updated value1") }>click</div>
					<div data-testid="ClickTargetProp2" onClick={ () => setValue("prop updated value2") }>click</div>
					<div data-testid="ClickTargetRef" onClick={ () => ref.current?.update("ref updated value") }>click</div>
		...
		const InnerComponent = () =>
			{
				...
				return (
					<div data-testid="ClickTargetHook" onClick={ () => update("hook updated value") }>click</div>
				);
			};
...
const isJsonEqual = (x: unknown, y: unknown) =>
...
test("useContext causes re-renders", async () =>
	{
		...
		const OuterComponent = () =>
			{
				...
				return (
					<Context1.Provider value={ORIGINAL_VALUE} ref={ref}>
						<div data-testid="ClickTargetRef1" onClick={ () => ref.current?.update(ORIGINAL_VALUE) }>click</div>
						<div data-testid="ClickTargetRef2" onClick={ () => ref.current?.update({ key1: "value1" }) }>click</div>
						<div data-testid="ClickTargetRef3" onClick={ () => ref.current?.update({ key1: "updated value" }) }>click</div>
		...
		// Invoke an update which is different by reference but identical by value.  Should not re-render the component with custom equal.
				...
				return (
					<Context1.Provider value={ORIGINAL_VALUE1} ref={ref1}>
						<Context2.Provider value={ORIGINAL_VALUE2} ref={ref2}>
							<div data-testid="ClickTargetRef1" onClick={ () => ref1.current?.update(ORIGINAL_VALUE1) }>click</div>
							<div data-testid="ClickTargetRef2" onClick={ () => ref1.current?.update({ key1: "value1" }) }>click</div>
							<div data-testid="ClickTargetRef3" onClick={ () => ref1.current?.update({ key1: "updated value1" }) }>click</div>
							<div data-testid="ClickTargetRef4" onClick={ () => ref2.current?.update(ORIGINAL_VALUE2) }>click</div>
							<div data-testid="ClickTargetRef5" onClick={ () => ref2.current?.update({ key2: "value2" }) }>click</div>
							<div data-testid="ClickTargetRef6" onClick={ () => ref2.current?.update({ key2: "updated value2" }) }>click</div>
		...
		const OuterComponent = () =>
			{
				...
				return (
					<Context1.Provider value="value" ref={ref}>
						<div data-testid="ClickTargetRef" onClick={ () => ref.current?.update("value") }>click</div>
						<UseContextComponent/>
		...
		const Component = () =>
			{
				...
				return (<>
					<div data-testid="ClickTarget1" onClick={updateValues}>click</div>
					<div data-testid="ClickTarget2" onClick={ () => setVisible(true) }>click</div>
