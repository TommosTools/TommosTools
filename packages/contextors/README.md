...
Contextors operate on local context values, allowing the associated data to be scoped appropriately,
and for the same selector-like logic to be reused within the app within different scopes.